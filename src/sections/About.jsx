    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
      ...
      <div className = "grid-default-color grid-2">
        <div ref={grid2Container} className='relative flex items-center justify-center w-full h-full'>
          <p className='flex items-end text-5xl text-gray-500'>Data Beats Opinions</p>
          <Card
      ...
      <div className='grid-black-color grid-3'>
        <div className="z-10 w-[50%]">
          ...
          <p className="subtext">I'm based in Bhubhaneshwar, India, and open to remote work worldwide</p>
        </div>
      ...
      <div className='grid-special-color grid-4'>
        <div className = 'flex flex-col items-center justify-center gap-4 size-full'>
          <p className='text-center headtext'>Let's Talk!</p>
          <CopyEmailButton/>
        </div>
      </div>
      {/* Grid 5  */}
